...
<html lang="en" >
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url('<?php echo asset('public/assets/app/media/img//bg/bg-2.jpg')?>');">
    ...
    @endif
							...
							{!! Form::open(array('url'=>'admin/login','method'=>'post','class'=>'m-login__form m-form')) !!}
								...
								<div class="m-login__form-action">
									{!!Form::submit('Sign In',array('class'=>'btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn','id'=>''))!!}
		...
		<!--end::Base Scripts -->   
        <!--begin::Page Snippets -->
		<script src="{{asset('public/assets/snippets/pages/user/login.js')}}" type="text/javascript"></script>
		<!--end::Page Snippets -->
	</body>
	<!-- end::Body -->
</html>
